...
create model in thie route `app/models/Contacts.js`
...
create this route here `app/api/Contacts/route.js`
...
the path of this file is different from the path of the first one you need to create route file here `app/api/Contacts/[id]/route.js`
...
for the client normally we create new page in this route `app/(pages)/contacts/page.jsx` but if the user want cutomize we can do it to 
like add this in componenets or seprate route as normal we create new page in this route `app/(pages)/contacts/page.jsx`
